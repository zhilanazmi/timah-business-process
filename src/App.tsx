...
import AnalisaSampelNonRutinEmbedPage from "./pages/embeds/AnalisaSampelNonRutinEmbedPage";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/embed/analisa-sampel-non-rutin" element={<AnalisaSampelNonRutinEmbedPage />} />
