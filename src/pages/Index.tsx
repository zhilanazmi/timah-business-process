    ...
    <main className="container mx-auto p-4 h-screen">
      <div className="mb-4">
        <div className="text-center py-2">
          <h1 className="text-3xl font-bold text-gray-800 mb-1">PT. Timah Industri</h1>
          <p className="text-sm text-gray-600 italic">Sistem Manajemen Diagram Alir Proses Bisnis</p>
        </div>
