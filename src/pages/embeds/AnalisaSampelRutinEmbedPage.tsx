...
import AnalisaSampelRutinEmbed from '../../components/embeds/AnalisaSampelRutinEmbed';

const AnalisaSampelRutinEmbedPage: React.FC = () => {
...
export default AnalisaSampelRutinEmbedPage; 