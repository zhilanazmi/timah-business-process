...
import AnalisaSampelNonRutinEmbed from '../../components/embeds/AnalisaSampelNonRutinEmbed';

const AnalisaSampelNonRutinEmbedPage: React.FC = () => {
...
export default AnalisaSampelNonRutinEmbedPage; 