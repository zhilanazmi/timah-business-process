...
import analisaSampelNonRutinFlow from '../../data/flows/analisaSampelNonRutin';

interface AnalisaSampelNonRutinEmbedProps {
...
const AnalisaSampelNonRutinEmbed: React.FC<AnalisaSampelNonRutinEmbedProps> = ({
  height = '600px',
  width = '100%',
  showControls = true,
  showMiniMap = false,
  ...
  const flowData = analisaSampelNonRutinFlow.defaultPages[0];
  const columns = analisaSampelNonRutinFlow.initialColumns;
  ...
  return (
    <EmbeddableFlowChart
      ...
      title={showTitle ? analisaSampelNonRutinFlow.title : undefined}
      height={height}
      width={width}
...
export default AnalisaSampelNonRutinEmbed; 